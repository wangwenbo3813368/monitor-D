<template>
 <div :style="subMenuHeight">
    <el-menu
        ...
        router
      >
        <li class="dp-menu-title" :style="getAsideWidth" >
           <el-input
            ...
            <i slot="prefix" class="el-input__icon el-icon-search"></i>
             ...
             <i v-show="!$store.state.sys.collapse" class="iconfont icon-menu self-icon-color" @click="collapseMenu" 
              style="float:right;margin-right:10px;font-size:24px;"></i>
 
          <div v-show="$store.state.sys.collapse" class="self-breadcrumb-collapse" @mouseover="showBreadcrumb"  @mouseleave="closeBreadcrumb">
             <i   class="iconfont icon-breadcrumbs  self-icon-color"  @click="collapseMenu" 
              style="margin-left:19px;font-size:24px;" ></i>
          </div>
          </li>
           <div v-if="showBreadcrumbFlag==true" class="self-breadcrumb" @mouseover="showBreadcrumb"  @mouseleave="closeBreadcrumb" >
               <el-breadcrumb separator-class="el-icon-arrow-right">
                <el-breadcrumb-item >监控信息</el-breadcrumb-item>
                <el-breadcrumb-item>一览列表</el-breadcrumb-item>
               </el-breadcrumb>
            </div>   
...
export default {
  ...
  methods: {
    ...
    closeBreadcrumb(e){
      if(e.clientY<=40||e.clientY>=76){
         this.showBreadcrumbFlag =false;
      }
    },
    //过滤掉不显示的路由菜单
    filterHidden(data){
  ...
  computed:{
    getAsideWidth(){
      return {"width":this.$store.state.sys.asideWidth+"px"};
    },
    subMenuHeight(){
    ...
    getBackgroundColor(){
       if(this.$store.state.sys.theme=='black'){
          return "#3C3F41";
       }else if(this.$store.state.sys.theme=='white'){
          return "#ffffff";
       }
    },
    getTextColor(){
...
.iconfont{
  // color: #7F99AC;
  @include menu_font_color(#ffffff);
}
