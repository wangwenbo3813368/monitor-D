    ...
    <header  class="header">
        ...
        <div class="header-right-left" >
         ...
         <div class="header-right">
            <i style="font-size:20px;margin-right:10px;" class=" iconfont icon-icon_skin_fill self-icon-skin" @click="changeSkin"></i>
...
export default {
  ...
  methods: {
    changeSkin(){
      ...
      window.document.documentElement.setAttribute("data-theme",theme);//一级处理
      this.$store.dispatch('setTheme',theme);//二级处理
      this.$EventBus.$emit("setTheme", {theme:theme});//三级处理
    },
    collapseMenu() {//侧边栏收缩 
